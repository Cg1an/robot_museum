...
//void PHC_GIMBAL(int16_t i1,int16_t i2)//��̨
//{
//	uint8_t DATA_TX[8];
//	
//	DATA_TX[0] = i1 >> 8;
...
//	CANx_SendStdData(&hcan1,0X200,DATA_TX,8);	//6020
//}

void Set_Shoot_Motor_Current(int16_t i1,int16_t i2, int16_t i3) //发射机构
{
	uint8_t DATA_TX[8];
...
//	DATA_TX[7] = i4;
	...
	CANx_SendStdData(&hcan1,0x200,DATA_TX,8);
